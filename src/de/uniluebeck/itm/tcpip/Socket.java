...
public class Socket implements JistAPI.DoNotRewrite {
	...
	private		java.net.Socket	socketConnection = null;
	...
	public void send(Vector data) throws IOException
	{
		int numBytes = 0;
		byte[] buffer;
...
*/	
	...
	public Vector receive(int bufSize) throws UnknownHostException, IOException
	{
		Vector returnData = new Vector(0);
		byte[] buffer;
		int bytesRead;
		int returnByte;
...
*/		
	...
	public Vector receive() throws UnknownHostException, IOException
	{
		return receive(2048);
	}
